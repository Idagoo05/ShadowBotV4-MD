...
let money = `${pickRandom([1000, 2000, 2500, 3000, 3700, 400, 450, 480, 500, 510, 6666, 680, 704, 760, 800, 840, 880, 900, 1000, 1059, 1080, 1100, 1190, 1230, 1380, 1399, 1290, 1300, 1340, 1350, 1590, 1400, 1450, 1700, 1800, 1900, 2000, 666, 60, 10, 1, 99, 999999, 17889, 1430])}` * 1
let moneypremium = `${pickRandom([5000, 6000, 7000, 8000, 9000, 10000, 1050, 1150, 1200, 1250, 1300, 1350, 1400, 1450, 1500, 1550, 1600, 1650, 1700, 1750, 1800, 1850, 1950, 2000, 2100, 2200, 2300, 2400, 2500, 2600, 2700, 2800, 2900, 3000, 3100, 3200, 3400, 3500, 3600, 3700, 3800, 3850, 3900, 3950, 4000])}` * 1
...
handler.help = ['minar2']
handler.tags = ['shadow']
handler.command = ['minar2', 'miming2', 'mine2', 'minarshadowcoins', 'minarcoins', 'minarshadow'] 
handler.fail = null
handler.exp = 0
